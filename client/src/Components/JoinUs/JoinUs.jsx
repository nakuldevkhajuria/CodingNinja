    ...
    return (
        <div>
            <div className='stories-button'>
                <button>
                    <span>
                        <span> Hear more stories from our alumni </span>
                    </span>

                </button>
            </div>
            <div className='fang-section'>
                <div className='fang-container'>
                    <div className='fang-content'>
                        <div className='fang-content-box1'>
                            <div >Why Join Us?</div>
                            <div > Great students deserve the best jobs </div>
                            <div> Coding Ninjas Makes it Happen... </div>
                        </div>
                        <div className='fang-content-box2'>
                            <div style={{ display: 'flex' }}>
                                <div className='fang-content-item1'>
                                    <img alt='hex' src="https://files.codingninjas.in/hex-9602.svg" />
                                    <div>
                                        <div> 150+ </div>
                                        <div> Students working in <br /> FAANG </div>
                                    </div>
                                </div>
                                <div className='fang-content-item1'>
                                    <img alt='hex' src="https://files.codingninjas.in/hex-9602.svg" />
                                    <div>
                                        <div> 10</div>
                                        <div> Students started their <br />  own companies </div>
                                    </div>
                                </div>

                            </div>
                            <div className='fang-two-boxes' style={{ display: 'flex' }}>
                                <div className='fang-content-item1'>
                                    <img alt='hex' src="https://files.codingninjas.in/hex-9602.svg" />
                                    <div>
                                        <div> 10</div>
